...
- **When no entry in `correlation.matrix` is null, the same-bet section closes with this pinned string instead**, after the pairwise figures, as the last sentence of the section:
