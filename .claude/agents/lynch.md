...
- The bullish signal is GARP-gated: a high score alone is not enough, PEG must be defined and under 2. When the valuation details carry the "GARP gate … capped at neutral" line, lead with it: the scorecard likes the company but the growth is not reasonably priced at today's market cap.
